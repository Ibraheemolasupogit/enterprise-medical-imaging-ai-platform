...
Milestones 1-5 are implemented in the current repository state. Milestone 5 does not implement
registration, NIfTI export, resampling, localisation, segmentation, classification, model training,
cloud deployment, or clinical decision support.
