...
terraform-fmt-check:
	$(PYTHON) -m medical_imaging_platform terraform-fmt-check

terraform-init:
	$(PYTHON) -m medical_imaging_platform terraform-init

terraform-validate:
	$(PYTHON) -m medical_imaging_platform terraform-validate

validate-aws-policy:
	$(PYTHON) -m medical_imaging_platform validate-aws-policy

scan-terraform:
	$(PYTHON) -m medical_imaging_platform scan-terraform

build-aws-evidence:
	$(PYTHON) -m medical_imaging_platform build-aws-evidence

validate-aws-evidence:
	$(PYTHON) -m medical_imaging_platform validate-aws-evidence

clean-terraform:
	$(PYTHON) -m medical_imaging_platform clean-terraform

aws-plan:
	$(PYTHON) -m medical_imaging_platform aws-plan

validate-observability:
	$(PYTHON) -m medical_imaging_platform validate-observability

build-observability-evidence:
	$(PYTHON) -m medical_imaging_platform build-observability-evidence

evaluate-slos:
	$(PYTHON) -m medical_imaging_platform evaluate-slos

simulate-incidents:
	$(PYTHON) -m medical_imaging_platform simulate-incidents

build-incident-evidence:
	$(PYTHON) -m medical_imaging_platform build-incident-evidence

validate-runbooks:
	$(PYTHON) -m medical_imaging_platform validate-runbooks

simulate-rollback:
	$(PYTHON) -m medical_imaging_platform simulate-rollback

validate-recovery:
	$(PYTHON) -m medical_imaging_platform validate-recovery

build-operations-evidence:
	$(PYTHON) -m medical_imaging_platform build-operations-evidence
